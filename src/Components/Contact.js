    ...
    return (
        <div>
            <div class="my-6 mt-16">
                <div class="grid sm:grid-cols-2 items-center gap-16 p-8 max-w-screen-xl mx-auto bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                    <div>
